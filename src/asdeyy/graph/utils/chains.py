...
from asdeyy.core.prompts import CHARACTER_CARD_PROMPT, ROUTER_PROMPT
from asdeyy.graph.utils.helpers import AsteriskRemovalParser, get_chat_model
...
def get_character_response_chain(summary: str = ""):
    ...
    if summary:
        system_message += f"\n\nSummary of conversation earlier between Asdeyy and the user: {summary}"

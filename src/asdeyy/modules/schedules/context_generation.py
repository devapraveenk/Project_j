...
from asdeyy.core.schedules import (
    FRIDAY_SCHEDULE,
    MONDAY_SCHEDULE,
    SATURDAY_SCHEDULE,
    SUNDAY_SCHEDULE,
...
class ScheduleContextGenerator:
    """Class to generate context about Asdeyy's current activity based on schedules."""
    ...
    def get_current_activity(cls) -> Optional[str]:
        """Get Asdeyy's current activity based on the current time and day of the week.
